...
import com.example.nicestart.databinding.ActivityMainBnBinding;
        ...
        mybottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.likes) {
                    ...
                    Toast.makeText(MainBn.this, "Likes clicked. Te encantan esos likes, ¿verdad?", Toast.LENGTH_SHORT).show();
                    removeBadge(mybottomNavView, itemId);
                    viewPager1.setCurrentItem(0);
                } else if (itemId == R.id.add) {
                    item.setChecked(true);
                    Toast.makeText(MainBn.this, "Add clicked. ¿Qué estás pensando en añadir?", Toast.LENGTH_SHORT).show();
                    removeBadge(mybottomNavView, itemId);
                    viewPager1.setCurrentItem(1);
                } else if (itemId == R.id.browse) {
                    item.setChecked(true);
                    Toast.makeText(MainBn.this, "Browse clicked. Navegando por las opciones, ¿eh?", Toast.LENGTH_SHORT).show();
                    removeBadge(mybottomNavView, itemId);
                    viewPager1.setCurrentItem(2);
                } else if (itemId == R.id.personal) {
                    item.setChecked(true);
                    Toast.makeText(MainBn.this, "Personal clicked. ¡Eres muy personal!", Toast.LENGTH_SHORT).show();
                    removeBadge(mybottomNavView, itemId);
